# sales-data-analysis
The objective of this mini project is to analyze sales data to identify patterns, trends and insights that can support in effective business decision making.
